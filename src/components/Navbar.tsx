      ...
      >
        <div className="max-w-7xl mx-auto h-full flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://wa.me/543514251651?text=Hola%20Estación%2027!"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden lg:flex items-center justify-center w-8 h-8 text-crema2 hover:text-[#25D366] transition-colors duration-200"
              aria-label="WhatsApp"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden lg:flex items-center justify-center w-8 h-8 text-crema2 hover:text-ambar transition-colors duration-200"
